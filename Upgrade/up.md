...
Dokumen ini berisi rancangan arsitektur untuk meng-upgrade bot scalping harian (`scalping_bot.py`) dari sistem *Rule-Based* menjadi sistem bertenaga AI kelas institusional, dengan mengadopsi modul-modul dari repositori `xaubot-ai`.
...
- [ ] **Fase 2 (Injeksi Prediksi):** Memodifikasi fungsi pencari sinyal di `scalping_bot.py` agar mengeksekusi *order* berdasarkan file `xgboost_model.pkl` hasil Fase 1.
